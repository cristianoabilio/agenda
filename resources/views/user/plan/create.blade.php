<div>
    ...
    <div class="container py-3">
        ...
        <div class="row">
            <div class="form-group col-12">
                <label>Email</label>
                <input type="email" name="email" id="email" v-model="item.name" class="form-control-plaintext" v-validate="'required|email'">
            </div>
        </div>
        ...
        <input type="hidden" id="user_id" v-model="item.id" name="user_id"  />
